...
VIDEO_DURATION_LIMIT = int(getenv("VIDEO_DURATION_LIMIT", 600*200)) # 20 minutes
...
#API_KEY = getenv("API_KEY", '30DxNexGenBots679197') #
YTPROXY_URL = getenv("YTPROXY_URL", 'https://tgapi.xbitcode.com') ## E.G https://yt.okflix.
YT_API_KEY = getenv("YT_API_KEY" , None ) ## get your secret key 
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+Osi2l0Gdj9wzYzE1")
...
START_IMG_URL = ["https://ibb.co/tMS0ZgZ8",
                 "https://ibb.co/tMS0ZgZ8"]
